...
class LoadMoreProgress extends StatefulWidget {
  final Size size;
  final Color color;
  final int count;
  final int milliseconds;

  const LoadMoreProgress({@required this.size, this.milliseconds: 300, this.color: Colors
      .green, this.count: 4});
...
class _ProgressState extends State<LoadMoreProgress> with TickerProviderStateMixin {
