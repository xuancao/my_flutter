...
class Test_List_Item extends StatelessWidget{

  TestItemModel netDot;

  VoidCallback onPressed;

  Test_List_Item({this.netDot,this.onPressed});
            ...
            new Row(
              children: <Widget>[
                new Expanded(
                    child: Text(
                      netDot.title,
                      style: new TextStyle(color: new Color(0xFF333333),fontSize: 18),
                    )),
                Text(
                  netDot.salary,
